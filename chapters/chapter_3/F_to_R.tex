...
Let $F, F^\prime$ fields. A function $\phi: F \rightarrow F^\prime$ is a homomorphism between $F$ and $F^\prime$ iff. it preserves the defined operations in both fields:
\begin{align*}
...
Let $F, F^\prime$ fields. A function $\phi: F \rightarrow F^\prime$ is an isomorphism iff. it is a homomorphism and also a bijection
\end{definition}
