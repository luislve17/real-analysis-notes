...
\NewEnviron{lemma}[1][]{%
  \sidetheorembox{lemma}{Lemma}{\ifx\relax#1\relax\else#1\\\fi}{\BODY}%
  \ifx\relax#1\relax\else%
    \addcontentsline{toc}{subsubsection}{\protect\numberline{\thelemma}#1}%
  \fi%
}
...
\NewEnviron{problem}[1][]{%
  ...
  \noindent{\color{accentline}\rule{\textwidth}{0.4pt}}\par\vspace{4pt}%
  \noindent{\bfseries Problem \theproblem.}%
...
\NewEnviron{solution}{%
  \par\vspace{0.5\baselineskip}\nobreak%
  \noindent{\bfseries\scshape Solution.}\ \BODY\hfill{\small$\blacksquare$}%
...
% ============================================
% TOC STYLING — Soviet/Grundlehren classical, restrained
% ============================================
\setcounter{tocdepth}{3}   % sections + subsections + named theorem/def/proof entries

% --- Title: plain, centered, one hairline rule ---
...
% --- SECTIONS: small caps — the one tier marker, used nowhere else ---
...
% --- SUBSECTIONS: plain roman, quiet, no competing weight ---
...
% --- SUBSUBSECTIONS (named theorems/definitions/proofs): small, plain, quiet ---
