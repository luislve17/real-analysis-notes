...
let us leave the inequality there to see more deeply what we want to achieve using $\delta$. The intuiton here is to find a value for $\delta$ that allows the inequality to hold, no matter what.
