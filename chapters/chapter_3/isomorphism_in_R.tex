...
Since $\alpha, \beta > 0$, and $q_1, q_2$ may be taken positive (density of $\mathbb{Q}$ lets us choose $q_1, q_2$ arbitrarily close to $\alpha, \beta$, in particular positive), we can multiply the inequalities:
