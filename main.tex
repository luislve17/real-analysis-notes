...
% TOC STYLING
% ============================================
% --- Contents title: plain, centered, minimal ---
...
% --- SECTIONS: plain, bold, no size jump — just weight ---
...
% --- SUBSECTIONS: plain roman, same family, just unbolded ---
...
% --- SUBSUBSECTIONS: smaller, quieter, still plain ---
...
\begin{document}
	\begin{titlepage}
	    ...
	    \thispagestyle{empty}
	    \centering
	    \includegraphics[width=\paperwidth,height=\paperheight]{assets/cover.jpg}
	    \restoregeometry
	\end{titlepage}
