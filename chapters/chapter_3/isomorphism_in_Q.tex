...
Let $\phi: \mathbb{Q} \rightarrow \mathbb{Q_F}$ defined as:
...
$\phi: \mathbb{Q} \rightarrow \mathbb{Q_F}$
...
\end{align*}
Therefore, we proved for any case of $n, k \in \mathbb{Z}: n < k \rightarrow n_\mathbb{F} < k_\mathbb{F}$
\end{enumerate}

\item $n > k \rightarrow n_\mathbb{F}> k_\mathbb{F}$
\\\\
Labeling accordingly: $n > k \leftrightarrow -n^\prime > -k^\prime \leftrightarrow n^\prime < k^\prime (n^\prime, k^\prime \in \mathbb{N})$\\
