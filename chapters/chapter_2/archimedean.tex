...
We now proceed to prove by contradiction, assuming $\exists x \in \mathbb{F}, \forall n \in \mathbb{N}:$
$$
n \leq x
$$
...
\begin{example}
Using an Archimedean field, that is not complete, lets take $\mathbb{F} = \mathbb{Q}$
...
Closing this chapter, lets emphazise the fact that the construction of $\mathbb{N} \subset \mathbb{F}$ by induction was crucial to generalize the property for any complete ordered field. Next we will explain why this wasn't necessary at all.
